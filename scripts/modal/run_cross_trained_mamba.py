...
def train_cross_trained_mamba(
    *,
    ...
    from analysis.active.ssl_experiments.cross_trained_mamba import CrossTrainedMambaConfig
    from analysis.active.ssl_experiments.cross_trained_mamba.train import run_cross_trained_mamba_with_callbacks
