...
- [Willett/Card Brain-to-Text](willett_card_b2t_design_notes.md)

These are source-focused notes; repository-specific decisions belong in the
relevant experiment's `design/` directory.
