...
- [experiments/bit_style/launchers/modal/run_s5_stage1.py](/Users/home/thesis/utah-ssl/experiments/bit_style/launchers/modal/run_s5_stage1.py)

Supporting Modal utilities are:

- [workflows/modal/create_utah_ssl_volumes.py](/Users/home/thesis/utah-ssl/workflows/modal/create_utah_ssl_volumes.py)
- [workflows/modal/extract_volume_archive.py](/Users/home/thesis/utah-ssl/workflows/modal/extract_volume_archive.py)
- [experiments/bit_style/launchers/modal/recompute_stage1_stats.py](/Users/home/thesis/utah-ssl/experiments/bit_style/launchers/modal/recompute_stage1_stats.py)
- [experiments/bit_style/launchers/modal/run_s5_stage2_ctc.py](/Users/home/thesis/utah-ssl/experiments/bit_style/launchers/modal/run_s5_stage2_ctc.py)
...
modal run workflows/modal/create_utah_ssl_volumes.py
```
...
```bash
cd /Users/home/thesis/utah-ssl
modal run workflows/modal/extract_volume_archive.py --archive /uploads/some_archive.tar --dest /
```
...
cd /Users/home/thesis/utah-ssl
modal run workflows/modal/extract_volume_archive.py --archive /uploads/brain2text24_smoothed_test.tar --dest /
```
...
cd /Users/home/thesis/utah-ssl
modal run workflows/modal/extract_volume_archive.py --archive /uploads/cache_v1_smoothed_rest.tar --dest /cache_v1_smoothed_sigma2p0
```
...
cd /Users/home/thesis/utah-ssl
modal run workflows/modal/extract_volume_archive.py --archive /uploads/stats_bit_stage1.tar --dest /
```
...
```bash
cd /Users/home/thesis/utah-ssl
modal run experiments/bit_style/launchers/modal/run_s5_stage1.py
```
...
```bash
cd /Users/home/thesis/utah-ssl
modal run experiments/bit_style/launchers/modal/run_s5_stage1.py --run-name bit_s5_stage1_seed7_60k
```
...
- a path outside the repository checkout
...
```bash
cd /Users/home/thesis/utah-ssl
modal run experiments/bit_style/launchers/modal/run_s5_stage2_ctc.py --stage1-run-name bit_s5_stage1_seed7_60k
```
...
```bash
cd /Users/home/thesis/utah-ssl
modal run experiments/bit_style/launchers/modal/run_s5_stage2_ctc.py \
...
4. run `modal run experiments/bit_style/launchers/modal/run_s5_stage1.py`
