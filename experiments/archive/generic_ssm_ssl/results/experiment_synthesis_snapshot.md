...
Historical result ledgers live in the [experiment archive](../../). Those files are kept
...
- The GRU reproduction is still useful as the recipe anchor, but it should be
  interpreted together with the [Willett GRU replication report](../../../supervised_baselines/results/willett_gru_replication.md)
...
See the [cache and statistics inventory](../../../../docs/data/cache_and_stats_inventory.md) before
...
- [POSSM-style reconstruction and transfer results](../../../possm_style/results/README.md)
- [S5 masked reconstruction](../../masked_reconstruction_ssl/results/s5_masked_reconstruction.md)
- [S5 future prediction](s5_future_prediction.md)
- [contrastive SSL](../../contrastive_ssl/results/README.md)
- [channel ablation](../../channel_ablation/results/README.md)
...
5. Keep recipe-fidelity fixes visible in
   the [Willett GRU replication report](../../../supervised_baselines/results/willett_gru_replication.md),
