...
python experiments/archive/generic_ssm_ssl/scripts/run_generic_ssm_ssl.py \
...
from experiments.archive.generic_ssm_ssl.config import GenericSSMSSLConfig
from experiments.archive.generic_ssm_ssl.training import run_generic_ssm_ssl
