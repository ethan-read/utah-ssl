...
> **Historical audit.** This checklist describes the repository before the
> clean-break package reorganization. Names such as `masked_ssl` identify the
> implementation that existed at the time, not the current active BIT path.
> The current design summary lives in
> `experiments/bit_style/design/README.md`.

This document translated the abstract BIT-to-`S5` adaptation plan into
concrete work against the pre-reorganization repository.
...
- [`experiments/archive/masked_reconstruction_ssl/notebooks/causal_masked_reconstruction.ipynb`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl/notebooks/causal_masked_reconstruction.ipynb)
...
- [`utah_ssl/models/s5.py`](/Users/home/thesis/utah-ssl/utah_ssl/models/s5.py:1)
...
- [`experiments/archive/masked_reconstruction_ssl/model.py`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl/model.py:1)
...
- [`experiments/archive/masked_reconstruction_ssl/objectives.py`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl/objectives.py:1)
...
- [`experiments/archive/masked_reconstruction_ssl/training.py`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl/training.py:1)
...
- [`experiments/archive/masked_reconstruction_ssl/probe.py`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl/probe.py:1)
- [`experiments/archive/ssl_autoresearch/train.py`](/Users/home/thesis/utah-ssl/experiments/archive/ssl_autoresearch/train.py:1)
...
- keep BIT-style SSL encoder / masked reconstruction path in:
  - [`experiments/archive/masked_reconstruction_ssl/`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl)
...
- [`experiments/archive/masked_reconstruction_ssl/training.py`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl/training.py:1)
- cache / sampler code under [`experiments/archive/masked_reconstruction_ssl/`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl)
...
- `experiments/archive/masked_reconstruction_ssl/phoneme_finetune.py`
...
- [`experiments/archive/masked_reconstruction_ssl/probe.py`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl/probe.py:1)
- [`experiments/archive/ssl_autoresearch/data.py`](/Users/home/thesis/utah-ssl/experiments/archive/ssl_autoresearch/data.py:1)
...
- `experiments/archive/masked_reconstruction_ssl/cascaded_decode.py`
...
- `experiments/bit_style/sentence_decoding/`
...
- `experiments/bit_style/sentence_decoding/model.py`
...
- `experiments/bit_style/sentence_decoding/alignment.py`
...
- `experiments/bit_style/sentence_decoding/lora.py`
...
- `experiments/archive/masked_reconstruction_ssl/README_BIT_path.md`
...
- [`experiments/archive/masked_reconstruction_ssl/tests/test_masked_ssl.py`](/Users/home/thesis/utah-ssl/experiments/archive/masked_reconstruction_ssl/tests/test_masked_ssl.py:1)
