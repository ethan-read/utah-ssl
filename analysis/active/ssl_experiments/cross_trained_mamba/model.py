...
try:
    from ssm_ssl.model import build_sequence_backbone
    from willett_reconstruction.model import SessionInputAdapterBank
except ModuleNotFoundError:  # pragma: no cover - repo-root unittest fallback
    from analysis.active.ssl_experiments.ssm_ssl.model import build_sequence_backbone
    from analysis.active.ssl_experiments.willett_reconstruction.model import SessionInputAdapterBank
