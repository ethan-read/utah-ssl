...
python analysis/active/ssl_experiments/ssm_ssl/scripts/run_generic_ssm_ssl.py \
...
from ssm_ssl.config import GenericSSMSSLConfig
from ssm_ssl.training import run_generic_ssm_ssl
