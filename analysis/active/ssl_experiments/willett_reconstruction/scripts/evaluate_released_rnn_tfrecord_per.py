...
from willett_reconstruction.data import prepare_willett_inputs  # noqa: E402
from willett_reconstruction.model import WillettPhonemeModel  # noqa: E402
from willett_reconstruction.released_tf_checkpoint import RELEASED_SESSIONS  # noqa: E402
from willett_reconstruction.representation_export import _build_config_from_checkpoint  # noqa: E402
from willett_reconstruction.train import _build_input_transform_config  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--derived-archive", type=Path, default=Path("analysis/active/ssl_experiments/willett_reconstruction/derived.tar.gz"))
