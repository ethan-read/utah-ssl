...
try:
    from ssm_ssl.model import GenericSSMEncoder, make_encoder_from_config
except ModuleNotFoundError:  # pragma: no cover - repo-root unittest fallback
    from analysis.active.ssl_experiments.ssm_ssl.model import GenericSSMEncoder, make_encoder_from_config
